...
export function MainMenuMenu({ actions }: MainMenuMenuProps) {
  return (
    <>
      ...
      <a className="hover:text-primary transition-colors uppercase flex items-center gap-1 focus:outline-none focus:text-primary" href="#help" aria-disabled="true" onClick={(event) => { event.preventDefault(); }}>
